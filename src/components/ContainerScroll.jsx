...
/**
 * Scroll-driven 3D card that rotates flat + scales as it enters view.
 * Converted from the provided .tsx to .jsx (project is JS/Vite, not TS).
 */
export function ContainerScroll({ titleComponent, children }) {
  ...
  return (
    <div
      className="h-[52rem] md:h-[70rem] flex items-center justify-center relative p-2 md:p-20"
      ref={containerRef}
    >
