...
export default function BuildAnimation() {
  ...
  return (
    <div className="relative anim-float" aria-hidden="true">
      {/* Browser frame */}
      <div className="rounded-2xl bg-white shadow-2xl shadow-teal-900/15 ring-1 ring-slate-900/5 overflow-hidden">
        {/* Title bar */}
        ...
        {/* Canvas being built */}
        <div className="relative p-4 h-64 bg-gradient-to-b from-teal-50/60 to-white">
          {/* Nav bar */}
          <div {...step(0.2)} className="anim-assemble flex items-center justify-between mb-3">
            <div className="h-3 w-16 rounded bg-teal-700" />
          ...
          <div className="grid grid-cols-5 gap-3 mb-3">
            ...
            <div {...step(0.7)} className="anim-assemble col-span-2 rounded-lg bg-gradient-to-br from-teal-200 to-teal-400" />
          </div>
      ...
      {/* Floating "Done!" badge */}
      <div className="absolute -bottom-4 -right-3 bg-teal-700 text-white text-xs font-semibold px-3 py-2 rounded-xl shadow-lg flex items-center gap-1.5">
