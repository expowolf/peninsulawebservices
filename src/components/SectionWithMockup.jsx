...
/**
 * Dark "section with mockup" block: staggered text on one side, a parallax
 * pair of stacked image cards on the other. Converted from the provided
 * .tsx to .jsx (project is JS/Vite). Animates in on scroll via framer-motion.
 */
        ...
        >
          ...
          >
            <div className="space-y-2 md:space-y-1">
              <h2 className="font-display text-white text-3xl md:text-[40px] font-semibold leading-tight md:leading-[1.15]">
                {title}
              </h2>
            </div>
