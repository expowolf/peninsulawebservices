      ...
      <div className="container-x">
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-3">
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className={`text-sm mt-1 leading-relaxed ${isActive ? 'text-slate-300' : 'text-slate-600'}`}>
                        {desc}
                      </p>
                    </div>
                  </div>
            ...
            <a href="#/services" className="inline-flex items-center gap-1.5 mt-4 text-sm font-semibold text-slate-900 hover:gap-2.5 transition-all">
