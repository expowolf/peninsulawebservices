...
export default function CtaBanner() {
  return (
    <section className="relative bg-slate-900 text-white overflow-hidden">
      ...
      <div className="absolute -top-32 -right-32 w-[28rem] h-[28rem] rounded-full bg-steel-500/30 blur-3xl" aria-hidden="true" />
      ...
      <div className="relative container-x py-24 md:py-32 text-center">
        <h2 className="font-display font-bold leading-[0.95] tracking-tight max-w-4xl mx-auto"
          ...
          Local Roots. <span className="text-steel-300">Modern Solutions.</span>
        </h2>
        ...
        <a
          href="#/contact"
          className="inline-flex items-center gap-2 mt-10 px-8 py-4 rounded-full bg-neutral-900 text-white font-semibold text-sm hover:bg-steel-300 transition-colors active:scale-[0.98] group"
        >
          Start Your Project
